...
console.log();
console.log("      ", chalk.bgMagenta.bold("Goat"), chalk.bgGreen.bold("Sheep"), chalk.bgMagentaBright.bold("Cow"), chalk.bgRedBright.bold("Buffalo"), chalk.bgYellow.bold("Camel"));
let condition = true;
while (condition) {
